...
def _build_default_formatter(level:int,
                             child_name:str,
                             colr_id:int,
                             formatter_class=logging.Formatter)->Union[logging.Formatter, CallStackFormatter]:
...
if DEBUGGING:
    ...
    logging.getLogger(project_root).setLevel(logging.DEBUG)
else:
    logging.getLogger(project_root).setLevel(logging.DEBUG)